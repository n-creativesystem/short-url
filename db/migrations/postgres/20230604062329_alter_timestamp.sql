...
ALTER TABLE "oauth2_client" ADD COLUMN "create_time" timestamptz NOT NULL, ADD COLUMN "update_time" timestamptz NOT NULL;
-- modify "oauth2_token" table
ALTER TABLE "oauth2_token" ADD COLUMN "create_time" timestamptz NOT NULL, ADD COLUMN "update_time" timestamptz NOT NULL;
-- modify "shorts" table
ALTER TABLE "shorts" ADD COLUMN "create_time" timestamptz NOT NULL, ADD COLUMN "update_time" timestamptz NOT NULL;
